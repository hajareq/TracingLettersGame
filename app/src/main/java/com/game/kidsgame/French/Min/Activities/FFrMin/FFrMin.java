package com.game.kidsgame.French.Min.Activities.FFrMin;
...
public class FFrMin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_f_fr_min);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), GFrMin.class));
            }
        });
