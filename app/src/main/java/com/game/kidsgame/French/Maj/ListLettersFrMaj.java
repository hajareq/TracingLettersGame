...
public class ListLettersFrMaj extends AppCompatActivity {
    public final static int LOOPS = 1000;
    public CarouselPagerAdapterFrMaj adapter;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_letters_fr_maj);
        ...
        adapter = new CarouselPagerAdapterFrMaj(this, getSupportFragmentManager());
