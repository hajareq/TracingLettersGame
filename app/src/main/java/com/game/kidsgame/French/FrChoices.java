...
public class FrChoices extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fr_choices);
 ...
 /*       numLength =  ObjectAnimator.ofFloat(num, "scaleX", 0.9f);
    ...
    /*    min.setTranslationY(-1000f);
        ...
        /*min.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(FrChoices.this, ListLettersFrMin.class);
                startActivity(i);
            }
        });*/
       ...
       /* num.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(FrChoices.this, ListNumbersFr.class);
                startActivity(i);
            }
        });*/
        ...
        maj.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(FrChoices.this, ListLettersFrMaj.class);
                startActivity(i);
    ...
    public void onBackPressed() {
        Intent i = new Intent(getApplicationContext(), FrGameFirst.class);
        startActivity(i);
        finish();
    }
}
