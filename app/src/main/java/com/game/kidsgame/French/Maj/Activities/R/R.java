...
public class R extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.game.kidsgame.R.layout.activity_r_fr_maj);
        ImageView home = findViewById(com.game.kidsgame.R.id.home);
        myActivity = this;
        ...
        play = 0;
        soundControl = findViewById(com.game.kidsgame.R.id.soundControl22);
        soundControl.setImageResource(com.game.kidsgame.R.mipmap.sound);
        soundControl.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                play++;
                if(play%2!=0) {
                    soundControl.setImageResource(com.game.kidsgame.R.mipmap.nosound);
        ...
        previous.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), Q.class));
            }
        });
    }
