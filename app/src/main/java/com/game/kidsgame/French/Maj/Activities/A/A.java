package com.game.kidsgame.French.Maj.Activities.A;
...
import com.game.kidsgame.SoundServiceOk;
...
public class A extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myActivity = this;
        setContentView(R.layout.activity_a_fr_maj);
        ...
        previous.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), Z.class));
            }
        });
    ...
    public void onWindowFocusChanged(boolean hasFocus){
        ...
        final View myView = findViewById(R.id.paintView);
        myView.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                myView.getLocationOnScreen(locations);
                int x = locations[0];
                int y = locations[1];

                System.out.println("X of view: "+ x);
                System.out.println("Y of view: "+ y);
