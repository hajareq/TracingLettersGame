package com.game.kidsgame.French;
...
public class FrGameFirst extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fr_game_first);

        play = 0;
        soundControl = findViewById(R.id.soundControl10);
        ...
        ObjectAnimator scaleDownX3 = ObjectAnimator.ofFloat(memoire, "scaleX", 1.1f);
        ObjectAnimator scaleDownY3 = ObjectAnimator.ofFloat(memoire, "scaleY", 1.1f);
        ...
        tracerlettre.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(),FrChoices.class));
            }
        });
